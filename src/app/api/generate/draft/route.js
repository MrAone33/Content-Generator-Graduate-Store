...
export async function POST(request) {
    ...
    try {
        ...
        const { keyword, anchor, url, tone, brief, length, includeAuthorityLink, contentType, language } = body;
        ...
        const draftHtml = await generateArticle(
            { keyword, tone, brief, url, anchor, context, length, includeAuthorityLink, contentType, language },
